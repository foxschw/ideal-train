...
public class LevelGenerator : MonoBehaviour {
	...
	// max amt of holes per level, public so accessible from gui to change
	public int maxHoleAmount = 3;

	// counter for hole creation (public so we can see how many have been created)
